...
public class GerenciadorReserva {
    ...
    private final Usuario usuarioLogado; // << NOVO: Armazena o usuário da sessão

    // << CORREÇÃO: Construtor agora aceita o Usuario logado >>
    ...
    /**
     * Exibe o menu de gerenciamento de reservas e processa a escolha do usuário.
     */
    ...
    private void inserir() {
        ...
        try {
            ...
            // 2. Lógica de negócio: reserva a vaga e atualiza o pacote
            pacoteSelecionado.reservarVaga();
            pacoteDAO.editar(pacoteSelecionado);

            // 3. Cria e insere a reserva usando o usuarioLogado
